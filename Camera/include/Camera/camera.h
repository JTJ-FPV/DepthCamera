...
public:
    ...
    bool classifiter1DpointSet(vector<cv::Point> &point, DBSCAN::DBSCAN &ds);
    ...
    vector<cv::Point> pixelOfEllipseGrad(const cv::RotatedRect &RRect, const cv::Rect &Rect,const cv::Mat &depth);
